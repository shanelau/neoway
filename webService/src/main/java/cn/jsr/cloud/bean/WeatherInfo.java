 ...
 */
@javax.persistence.Table(name = "weather_info", schema = "", catalog = "weather_cloud_db")
@Entity
public class WeatherInfo extends AbstractModel {
    ...
    private Collection<Logs> logsesByWeId;
    ...
    public Collection<Logs> getLogsesByWeId() {
        return logsesByWeId;
    }

    public void setLogsesByWeId(Collection<Logs> logsesByWeId) {
