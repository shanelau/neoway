...
public class ConfInfo {
    ...
    private Collection<Project> projectsByConfFileId;
    ...
    @OneToMany(mappedBy = "confInfoByConfFileId")
    public Collection<Project> getProjectsByConfFileId() {
        return projectsByConfFileId;
    }

    public void setProjectsByConfFileId(Collection<Project> projectsByConfFileId) {
        this.projectsByConfFileId = projectsByConfFileId;
    }
}
