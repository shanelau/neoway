...
public class WeatherLogs extends AbstractModel {
    ...
    public boolean equals(Object o) {
        ...
        WeatherLogs weatherLogs = (WeatherLogs) o;

        if (logId != weatherLogs.logId) return false;
        if (requestDate != null ? !requestDate.equals(weatherLogs.requestDate) : weatherLogs.requestDate != null)
            return false;
        if (userId != null ? !userId.equals(weatherLogs.userId) : weatherLogs.userId != null) return false;
