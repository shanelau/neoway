...
<body>
<div class="container logo_head hidden-xs">
            <div class="twocol ">
                <a href="" title="Go Home" class="logo"><img src="images/logo.png" alt="jsr.rom.com"></a>
            </div>
</div>
<section class="container">
    <div class="web_login col-xs-12 col-md-4 col-ls-4 col-lg-offset-4">
