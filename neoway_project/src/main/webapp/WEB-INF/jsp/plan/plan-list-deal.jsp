    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <h3 class="page-title">等待处理计划单<small></small>  <span class="text-error controls">${msg}</span></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                <c:forEach var="model" items="${dealList}" varStatus="s">
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn" rel="popoverTop" data-content="邮箱:${model.lastUser.email}<br/>手机:${model.lastUser.phone}" title="真名:${model.lastUser.trueName}" data-html="true" data-original-title="Popover on top">${model.lastUser.userName}</a></td>
                                        <td> <a href="#" class="btn " rel="popoverTop" data-content="${model.dealAdvice}" data-original-title="处理意见：">点击查看</a></td>
                                        <td><a href="#" class="btn" rel="popoverTop" data-content="邮箱:${model.dealUser.email}<br/>手机:${model.dealUser.phone}" title="真名:${model.lastUser.trueName}" data-html="true" data-original-title="Popover on top">${model.dealUser.userName}</a></td>
