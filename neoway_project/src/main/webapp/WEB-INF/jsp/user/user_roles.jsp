        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title"> 用户角色 <small>权限管理</small> <span class="text-error controls">${msg}</span> </h3>
                    <ul class="breadcrumb">
            ...
            <div class="alert alert-success"><button class="close" data-dismiss="alert"></button>
                <strong>提示!</strong> 计划员才具有创建计划单的权限。</div>
            <div class="row-fluid">
                <div class="span12">
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    <div id="legend" class="">
                                        <legend class="">用户信息：${manuUser.userName}</legend>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>      <c:choose>
                                                    <c:when test="${roleModel.containt}">
                                                        <a href="user/update_user_role?userId=${manuUser.userId}&roleId=${roleModel.roles.roleId}&type=delete" class="btn red">关闭</a></td>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="user/update_user_role?userId=${manuUser.userId}&roleId=${roleModel.roles.roleId}&type=add" class="btn green">激活</a></td>
                                                    </c:otherwise>
                                                </c:choose>
