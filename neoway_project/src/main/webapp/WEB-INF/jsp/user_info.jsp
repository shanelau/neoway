    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span6 portlet box ">
                ...
                <form class="form-horizontal" action="user/update" method="post">
                    <fieldset>
                        ...
                        <div class="alert-error">${user_update_msg}</div>
            ...
            <div class="span6 box">
                ...
                <form class="form-horizontal" method="post" action="user_password" name="update_password">
                    <fieldset>
                        <div id="legend" class="">
                            <legend class="">修改密码</legend> <div class="alert-error">${ param.msg}</div>
                        </div>
                        <div class="control-group">
