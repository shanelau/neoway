...
<div id="upload_file_modal" class="modal hide">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="input-xlarge .type_id" name="soft_type_id">
                            <option value="1">烧录软件</option>
                            <option value="2">下载软件</option>
                            <option value="3">软件下载工具</option>
                            <option value="4">校准综测工具</option>
                            <option value="5">写号工具</option>
                            <option value="6">信息检查工具</option>
                            <option value="7">包装工具</option>
                            <option value="8">打印工具</option>
                        </select>
                    </div>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary green" id="file_up">提交</button>
    </div>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">编辑计划单
            <small></small>    <span class="text-error controls">${param.msg}</span>
        </h3>
        <ul class="breadcrumb">
                ...
                <form class="form-horizontal" action="/plan/create_conf" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                          ...
                          <input type="file" class="default" name="confPath"
                                 value="${project.confInfoByConfFileId.confFileName}">
...
<div class="row-fluid">
    <div class="span12">
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                <div class="alert alert-error"><strong>提示!</strong>选择系统保存过的文件，如果没有合适的文件，请先上传。</div>
    ...
    (function () {
        ...
        $(".shenpi_btn").bind("click",function(){
            ...
            $.post(
                    ...
                    function(data){
                        alert(data.msg);
                        widown.location.href="/plan/plan-list-deal";
                    },
                    'json'
            );
