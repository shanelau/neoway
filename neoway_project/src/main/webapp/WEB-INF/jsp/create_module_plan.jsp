                ...
                <div class="portlet-body">
                    ...
                    <div class="controls-row">
                        ...
                        <div class="controls-row">
                            ...
                            <input class="span2 m-wrap" type="text" name="packResource">
                        </div>
                        <div class="controls-row">
                            ...
                            <input class="span2 m-wrap" type="text" name="packPeiliao">
                        </div>
                        <div class="controls-row">
                            <label class="span2 control-label">彩盒包装料单</label>
                            <input class="span2 m-wrap" type="text" name="packCaihe">
                            <label class="span2 control-label">大卡通包装料单</label>
                            <input class="span2 m-wrap" type="text" name="packDakat">
                        ...
                        <div class="controls-row">
                            ...
                            <input class="span2 m-wrap" type="text" name="packImeiStart">
                            <label class="span2 control-label">IMEI结尾</label>
                            <input class="span2 m-wrap" type="text" name="packImeiEnd">
                        </div>
                        <div class="controls-row">
                        ...
                        <div class="controls-row">
                            ...
                            <input class="span10" type="text"  placeholder="输入需要抄送的邮箱账号，用‘,’隔开" name="sendEmail">
                        </div>
