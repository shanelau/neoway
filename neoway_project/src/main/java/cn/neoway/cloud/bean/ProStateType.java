 ...
 */
@javax.persistence.Table(name = "pro_state_type", schema = "", catalog = "neoway")
@Entity
public class ProStateType extends AbstractModel {
    ...
    public boolean equals(Object o) {
        ...
        ProStateType that = (ProStateType) o;
    ...
    @OneToMany(mappedBy = "proStateTypeByProPlanStateId")
