package cn.neoway.common.dao.hibernate4;

import cn.neoway.common.dao.IBaseDao;
import cn.neoway.common.dao.util.ConditionQuery;
import cn.neoway.common.dao.util.OrderBy;
import cn.neoway.common.pagination.PageUtil;
import cn.neoway.common.util.Assert;
...
public abstract class BaseHibernateDao<M extends java.io.Serializable, PK extends java.io.Serializable> implements IBaseDao<M, PK> {
    ...
    public List<M> listAll() {
        return listWithoutPnParam(HQL_LIST_ALL,null);
    }
     ...
     * @return
     */
    public List<M> findBy(String propertyName,String value) {
        Criteria c = getSession().createCriteria(this.entityClass);
        c.add(Restrictions.eq(propertyName, value));
        return c.list();
    }
